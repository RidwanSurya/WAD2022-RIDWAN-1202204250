...
<!-- Grid -->
    <div class="container text-center">
        <div class="row">
            ...
            <p align="left">Edit mobil BMW M3 Competition</p>
<!-- Kanan -->
            <div class="col"></br></br></br></br>
                <img src="../Asset/Image/bmw.jpg" class="rounded mx-auto d-block" alt="bmw" height="300" width="Automatic">
            </div>
<!-- Kiri -->
            ...
            <form>
                ...
                <a class="btn btn-primary" href="../pages/ListCar-Ridwan.php" role="button">Selesai</a>
                </form> 
                </div>
            </div>
        </div>
