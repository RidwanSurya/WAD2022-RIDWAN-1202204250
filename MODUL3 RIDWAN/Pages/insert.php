...
if (isset($_POST['submit'])){
    ...
    $query = mysqli_query($connect, "UPDATE INTO showroom_ridwan_table(id_mobil,nama_mobil, pemilik_mobil, merk_mobil, tanggal_beli, deskripsi, foto_mobil, status_pembayaran)
